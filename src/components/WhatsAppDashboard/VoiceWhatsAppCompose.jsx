...
const TRANSLATIONS = {
    'en-US': {
        labels: { to: 'contact name', body: 'whatsapp message' },
        welcome_new: 'Welcome to WhatsApp Voice Compose. Let me help you write a message.',
        ...
        welcome_long: 'Welcome to WhatsApp Voice Compose. I will help you compose securely. Starting with the contact name. There are {count} contacts on your screen. You can say their name or their number.',
    ...
    'hi-IN': {
        labels: { to: 'संपर्क का नाम', body: 'व्हाट्सएप संदेश' },
        welcome_new: 'व्हाट्सएप वॉयस कंपोज़ में आपका स्वागत है। मुझे एक संदेश लिखने में आपकी मदद करने दें।',
        ...
        welcome_long: 'व्हाट्सएप वॉयस कंपोज़ में आपका स्वागत है। मैं आपको सुरक्षित रूप से संदेश लिखने में मदद करूँगा। संपर्क नाम से शुरू करते हैं। आपकी स्क्रीन पर {count} संपर्क हैं। आप उनका नाम या नंबर बोल सकते हैं।',
    ...
    'es-ES': {
        labels: { to: 'nombre del contacto', body: 'mensaje de whatsapp' },
        welcome_new: 'Bienvenido a WhatsApp Composición por Voz. Déjame ayudarte a escribir un mensaje.',
        ...
        welcome_long: 'Bienvenido a Composición por Voz. Te ayudaré a redactar de forma segura. Empezando por el nombre del contacto. Hay {count} contactos en tu pantalla. Puedes decir su nombre o su número.',
    ...
    'fr-FR': {
        labels: { to: 'nom du contact', body: 'message whatsapp' },
        welcome_new: 'Bienvenue dans la composition vocale WhatsApp. Laissez-moi vous aider à écrire un message.',
        welcome_reply: 'Réponse vocale activée. Laissez-moi vous aider à écrire la réponse.',
        reply_activated: 'Réponse vocale activée. Je vais ajouter vos mots au message. Prêt quand vous l\'êtes.',
        welcome_long: 'Bienvenue dans la composition vocale. Je vais vous aider à rédiger en toute sécurité. En commençant par le nom du contact. Il y a {count} contacts sur votre écran. Vous pouvez dire leur nom ou leur numéro.',
        speak_now: 'Parlons de {field}. Dites {field} maintenant.',
        who_message: 'À qui voulez-vous envoyer un message? Vous pouvez dire le nom d\'un contact, ou dire numéro un, numéro deux, etc.',
        ...
        contact_not_exist: "Le contact numéro {num} n'existe pas. Veuillez plutôt dire son nom.",
        cleared: '{field} effacé. Veuillez dire {field} à nouveau.',
        contact_updated: 'Contact mis à jour à {name}. Dites "envoyer le message" pour l\'envoyer ou "réviser" pour écouter le message complet.',
        got_it_messaging: 'Compris. Messagerie {name}. Maintenant, s\'il vous plaît, dites-moi votre message.',
        message_recorded: 'Message enregistré. Dites "envoyer le message" pour l\'envoyer ou "réviser" pour écouter le message complet.',
        ...
        review_msg: 'Message à {to}. Message: {body}. Dites "envoyer le message" pour l\'envoyer ou "modifier" pour faire des changements.',
    ...
    'bn-IN': {
        labels: { to: 'যোগাযোগের নাম', body: 'হোয়াটসঅ্যাপ বার্তা' },
        welcome_new: 'হোয়াটসঅ্যাপ ভয়েস কম্পোজে স্বাগতম। আমাকে একটি বার্তা লিখতে সাহায্য করতে দিন।',
        welcome_reply: 'ভয়েস উত্তর সক্রিয় করা হয়েছে। আমাকে উত্তরটি লিখতে সাহায্য করতে দিন।',
        reply_activated: 'ভয়েস উত্তর সক্রিয় করা হয়েছে। আমি বার্তায় আপনার শব্দ যোগ করব। আপনি প্রস্তুত হলে বলুন।',
        welcome_long: 'হোয়াটসঅ্যাপ ভয়েস কম্পোজে স্বাগতম। আমি আপনাকে নিরাপদে বার্তা লিখতে সাহায্য করব। যোগাযোগের নাম দিয়ে শুরু করছি। আপনার স্ক্রিনে {count} টি যোগাযোগ রয়েছে। আপনি তাদের নাম বা নম্বর বলতে পারেন।',
        speak_now: 'এখন {field} বলছি। আপনার {field} এখন বলুন।',
        who_message: 'আপনি কাকে বার্তা দিতে চান? আপনি যোগাযোগের নাম বলতে পারেন, অথবা নম্বর এক, নম্বর দুই বলতে পারেন।',
        did_not_catch: "দুঃখিত, আমি বুঝতে পারিনি। আবার চেষ্টা করুন।",
        say_contact_name: 'যোগাযোগের নাম বলুন।',
        say_message: 'বার্তা বলুন।',
        contact_not_exist: "যোগাযোগ নম্বর {num} বিদ্যমান নেই। দয়া করে নামের পরিবর্তে এটি বলুন।",
        cleared: '{field} মুছে ফেলা হয়েছে। দয়া করে {field} আবার বলুন।',
        contact_updated: 'যোগাযোগ {name} এ আপডেট করা হয়েছে। পাঠানোর জন্য "বার্তা পাঠান" বলুন বা সম্পূর্ণ বার্তা শোনার জন্য "পর্যালোচনা" বলুন।',
        got_it_messaging: 'বুঝতে পেরেছি। {name} কে বার্তা পাঠানো হচ্ছে। এখন দয়া করে আপনার বার্তা বলুন।',
        message_recorded: 'বার্তা রেকর্ড করা হয়েছে। পাঠানোর জন্য "বার্তা পাঠান" বলুন বা সম্পূর্ণ বার্তা শোনার জন্য "পর্যালোচনা" বলুন।',
        cancel_compose: 'বার্তা লেখা বাতিল করা হয়েছে।',
        which_edit: 'আপনি কোন ফিল্ড সম্পাদনা করতে চান? যোগাযোগ বা বার্তা বলুন।',
        help_cmd: 'দয়া করে "বার্তা পাঠান", "পর্যালোচনা", বা "সম্পাদনা" বলুন।',
        say_new_contact: 'দয়া করে নতুন যোগাযোগ বলুন।',
        say_new_message: 'দয়া করে নতুন বার্তা বলুন।',
        cancel_edit: 'সম্পাদনা বাতিল করা হয়েছে। বার্তা পাঠান বা পর্যালোচনা বলুন।',
        help_edit: 'দয়া করে যোগাযোগ বা বার্তা বলুন।',
        review_msg: '{to} কে বার্তা। বার্তা: {body}। পাঠানোর জন্য "বার্তা পাঠান" বলুন বা পরিবর্তনের জন্য "সম্পাদনা" বলুন।',
        closing: 'উইন্ডো বন্ধ করা হচ্ছে।',
        help_error: 'দয়া করে আবার চেষ্টা করুন বা উইন্ডো বন্ধ করুন বলুন।',
        missing_fields: 'সবগুলো ফিল্ড বাধ্যতামূলক। দয়া করে বাদ পড়া ফিল্ড পূরণ করুন।',
        sending: 'আপনার বার্তা এখন পাঠানো হচ্ছে।',
        sent_success: 'আপনার বার্তা সফলভাবে পাঠানো হয়েছে!',
        send_error: 'বার্তা পাঠাতে ব্যর্থ: {error}'
    },
    'ta-IN': {
        labels: { to: 'தொடர்பு பெயர்', body: 'வாட்ஸ்அப் செய்தி' },
        welcome_new: 'வாட்ஸ்அப் குரல் முறைக்கு வரவேற்கிறோம். நான் செய்தி எழுத உதவுகிறேன்.',
        welcome_reply: 'குரல் பதில் இயக்கப்பட்டது. பதிலை எழுத உதவுகிறேன்.',
        reply_activated: 'குரல் பதில் இயக்கப்பட்டது. நீங்கள் சொல்வதை உள்ளிடுவேன். தயாரானதும் சொல்லுங்கள்.',
        welcome_long: 'வாட்ஸ்அப் குரல் முறைக்கு வரவேற்கிறோம். நான் பாதுகாப்பாக செய்தி எழுத உதவுகிறேன். உங்கள் திரையில் {count} தொடர்புகள் உள்ளன. அவர்களின் பெயரையோ அல்லது எண்ணையோ சொல்லலாம்.',
        speak_now: 'இப்போது {field} ஆவதற்காக கேக்குறேன். {field} பற்றி சொல்லுங்கள்.',
        who_message: 'நீங்கள் யாருக்கு செய்தி அனுப்ப விரும்புகிறீர்கள்? நீங்கள் தொடர்பு பெயரையோ, அல்லது எண் ஒன்று, எண் இரண்டு என்றோ சொல்லலாம்.',
        did_not_catch: "மன்னிக்கவும், எனக்குப் புரியவில்லை. மீண்டும் முயற்சிக்கவும்.",
        say_contact_name: 'தொடர்பு பெயரைச் சொல்லுங்கள்.',
        say_message: 'செய்தியைச் சொல்லுங்கள்.',
        contact_not_exist: "தொடர்பு எண் {num} இல்லை. அதற்கு பதிலாக பெயரைச் சொல்லுங்கள்.",
        cleared: '{field} அழிக்கப்பட்டது. தயவுசெய்து {field} மீண்டும் சொல்லுங்கள்.',
        contact_updated: 'தொடர்பு {name} ஆக புதுப்பிக்கப்பட்டது. அனுப்ப "செய்தி அனுப்பு" என்று சொல்லுங்கள் அல்லது மொத்த செய்தியைக் கேட்க "மதிப்பாய்வு" என்று சொல்லுங்கள்.',
        got_it_messaging: 'புரிந்தது. {name} க்கு செய்தி அனுப்புகிறேன். இப்போது தயவுசெய்து உங்கள் செய்தியைச் சொல்லுங்கள்.',
        message_recorded: 'செய்தி பதிவு செய்யப்பட்டது. அனுப்ப "செய்தி அனுப்பு" என்று சொல்லுங்கள் அல்லது மொத்த செய்தியைக் கேட்க "மதிப்பாய்வு" என்று சொல்லுங்கள்.',
        cancel_compose: 'செய்தி எழுதுவது ரத்து செய்யப்பட்டது.',
        which_edit: 'எந்தப் பகுதியை மாற்ற விரும்புகிறீர்கள்? தொடர்பு அல்லது செய்தி என்று சொல்லுங்கள்.',
        help_cmd: 'தயவுசெய்து "செய்தி அனுப்பு", "மதிப்பாய்வு", அல்லது "மாற்று" என்று சொல்லுங்கள்.',
        say_new_contact: 'தயவுசெய்து புதிய தொடர்பைச் சொல்லுங்கள்.',
        say_new_message: 'தயவுசெய்து புதிய செய்தியைச் சொல்லுங்கள்.',
        cancel_edit: 'மாற்றுவது ரத்து செய்யப்பட்டது. செய்தி அனுப்பு அல்லது மதிப்பாய்வு என்று சொல்லுங்கள்.',
        help_edit: 'தயவுசெய்து தொடர்பு அல்லது செய்தி என்று சொல்லுங்கள்.',
        review_msg: '{to} க்கான செய்தி. செய்தி: {body}. அனுப்ப "செய்தி அனுப்பு" என்று சொல்லுங்கள் அல்லது மாற்ற "மாற்று" என்று சொல்லுங்கள்.',
        closing: 'சாளரத்தை மூடுகிறது.',
        help_error: 'தயவுசெய்து மீண்டும் முயற்சிக்கவும், அல்லது சாளரத்தை மூடு என்று சொல்லுங்கள்.',
        missing_fields: 'அனைத்து பகுதிகளும் கட்டாயம். விடுபட்ட பகுதிகளை நிரப்பவும்.',
        sending: 'உங்கள் செய்தி இப்போது அனுப்பப்படுகிறது.',
        sent_success: 'உங்கள் செய்தி வெற்றிகரமாக அனுப்பப்பட்டது!',
        send_error: 'செய்தியை அனுப்ப முடியவில்லை: {error}'
    },
    'te-IN': {
        labels: { to: 'పరిచయం పేరు', body: 'వాట్సాప్ సందేశం' },
        welcome_new: 'వాట్సాప్ వాయిస్ కంపోజ్‌కు స్వాగతం. మీకు సందేశం రాయడంలో సహాయం చేయనివ్వండి.',
        welcome_reply: 'వాయిస్ రిప్లై యాక్టివేట్ చేయబడింది. రిప్లై రాయడంలో సహాయం చేయనివ్వండి.',
        reply_activated: 'వాయిస్ రిప్లై యాక్టివేట్ చేయబడింది. నేను మీ పదాలను సందేశానికి జోడిస్తాను. మీరు సిద్ధంగా ఉన్నప్పుడు చెప్పండి.',
        welcome_long: 'వాట్సాప్ వాయిస్ కంపోజ్‌కు స్వాగతం. నేను మీకు సురక్షితంగా సందేశం రాయడంలో సహాయం చేస్తాను. పరిచయం పేరుతో ప్రారంభిద్దాం. మీ స్క్రీన్‌పై {count} పరిచయాలు ఉన్నాయి. మీరు వారి పేరు లేదా నంబర్ చెప్పవచ్చు.',
        speak_now: 'ఇప్పుడు {field} మాట్లాడుతున్నాను. మీ {field} చెప్పండి.',
        who_message: 'మీరు ఎవరికి సందేశం పంపాలనుకుంటున్నారు? మీరు పరిచయం పేరును చెప్పవచ్చు, లేదా నంబర్ వన్, నంబర్ టూ అని చెప్పవచ్చు.',
        did_not_catch: "క్షమించండి, నాకు అర్థం కాలేదు. దయచేసి మళ్ళీ ప్రయత్నించండి.",
        say_contact_name: 'పరిచయం పేరును చెప్పండి.',
        say_message: 'సందేశాన్ని చెప్పండి.',
        contact_not_exist: "పరిచయం నంబర్ {num} ఉనికిలో లేదు. దయచేసి దాని బదులు పేరు చెప్పండి.",
        cleared: '{field} క్లియర్ చేయబడింది. దయచేసి {field} మళ్ళీ చెప్పండి.',
        contact_updated: 'పరిచయం {name} కు నవీకరించబడింది. పంపడానికి "సందేశం పంపు" అని చెప్పండి లేదా పూర్తి సందేశాన్ని వినడానికి "పరిశీలించు" అని చెప్పండి.',
        got_it_messaging: 'అర్థమైంది. {name} కు సందేశం పంపుతున్నాను. ఇప్పుడు దయచేసి మీ సందేశాన్ని చెప్పండి.',
        message_recorded: 'సందేశం రికార్డ్ చేయబడింది. పంపడానికి "సందేశం పంపు" అని చెప్పండి లేదా పూర్తి సందేశాన్ని వినడానికి "పరిశీలించు" అని చెప్పండి.',
        cancel_compose: 'సందేశం రాయడం రద్దు చేయబడింది.',
        which_edit: 'మీరు ఏ ఫీల్డ్‌ను సవరించాలనుకుంటున్నారు? పరిచయం లేదా సందేశం చెప్పండి.',
        help_cmd: 'దయచేసి "సందేశం పంపు", "పరిశీలించు", లేదా "సవరించు" చెప్పండి.',
        say_new_contact: 'దయచేసి కొత్త పరిచయం చెప్పండి.',
        say_new_message: 'దయచేసి కొత్త సందేశాన్ని చెప్పండి.',
        cancel_edit: 'సవరణ రద్దు చేయబడింది. సందేశం పంపు లేదా పరిశీలించు చెప్పండి.',
        help_edit: 'దయచేసి పరిచయం లేదా సందేశం చెప్పండి.',
        review_msg: '{to} కి సందేశం. సందేశం: {body}. పంపడానికి "సందేశం పంపు" అని చెప్పండి లేదా మార్పుల కోసం "సవరించు" చెప్పండి.',
        closing: 'విండోను మూసివేస్తున్నాను.',
        help_error: 'దయచేసి మళ్ళీ ప్రయత్నించండి లేదా విండోను మూసివేయండి చెప్పండి.',
        missing_fields: 'అన్ని ఫీల్డ్‌లు తప్పనిసరి. దయచేసి తప్పిపోయిన ఫీల్డ్‌లను పూరించండి.',
        sending: 'మీ సందేశం పంపబడుతోంది.',
        sent_success: 'మీ సందేశం విజయవంతంగా పంపబడింది!',
        send_error: 'సందేశం పంపడంలో విఫలమైంది: {error}'
    }
};
...
const VoiceWhatsAppCompose = ({ user, onClose, onSent, prefill, contacts = [], isMuted = false }) => {
    ...
    const fieldOrder = ['to', 'body'];
    const fieldLabels = {
        to: t.labels?.to || 'contact name',
        body: t.labels?.body || 'whatsapp message'
    };
    ...
    const startFieldListening = useCallback((field) => {
        ...
        rec.lang = userLang || 'en-US'; rec.interimResults = true; rec.continuous = false; rec.maxAlternatives = 1;
    ...
    const handleFieldInput = (field, transcript) => {
        ...
        if (field === 'to') {
            ...
            if (match) {
                ...
                // Try to find a partial match in contacts
    ...
    const sendWhatsApp = async () => {
        ...
        try {
            await whatsappApi.sendMessage(currentForm.to, currentForm.body);
    ...
    return (
        <div className="voice-compose-overlay" style={{ zIndex: 99999 }}>
            <div className="voice-compose-modal glass-panel" style={{ borderTop: '4px solid #25D366' }}>
                <div className="voice-compose-header">
                    <span className="modal-title" style={{ color: '#25D366' }}>
                        <MessageCircle size={18} /> WhatsApp Voice Compose
                    </span>
                ...
                <div className="voice-guidance">
                    <div className="guidance-content">
                        <div className="guidance-icon" style={isListening ? { color: '#25D366', textShadow: '0 0 10px #25D366' } : {}}>
                        ...
                        <div className="guidance-text">
                            ...
                            {currentField && (
                                <p className="guidance-field">
                                    Current field: <strong style={{ color: '#25D366' }}>{fieldLabels[currentField]}</strong>
                                </p>
                            )}
                        </div>
                    </div>
                ...
                <div className="voice-compose-form">
                    ...
                    <div className="form-field">
                        ...
                        <div className="field-content">
                            <input
                                ...
                                style={currentField === 'to' ? { borderColor: '#25D366' } : {}}
                            />
                            <button
                                type="button"
                        ...
                        <div style={{ background: 'rgba(0,0,0,0.3)', borderRadius: '12px', padding: '12px', marginBottom: '16px', display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                            ...
                            {contacts.map((c, i) => (
                                <div key={c.id}
                                    ...
                                    style={{ background: 'rgba(37, 211, 102, 0.1)', border: '1px solid rgba(37, 211, 102, 0.3)', borderRadius: '16px', padding: '4px 12px', fontSize: '14px', cursor: 'pointer' }}>
                                    <strong style={{ color: '#25D366' }}>{i + 1}.</strong> {c.name}
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    <div className="form-field">
                        ...
                        <div className="field-content">
                            <textarea
                                ...
                                style={currentField === 'body' ? { borderColor: '#25D366' } : {}}
                            />
                            <button
                                type="button"
                                className="field-mic-btn"
                    ...
                    <div className="compose-actions">
                        ...
                        <button className="send-btn" style={{ background: '#25D366', color: '#000' }} onClick={handleManualSend} disabled={status.type === 'loading' || isListening}>
                            {status.type === 'loading' ? <><Loader size={16} className="spin" /> Sending...</> : <><Send size={16} /> Send</>}
                        </button>
                    </div>
                </div>
            </div>
...
export default VoiceWhatsAppCompose;
